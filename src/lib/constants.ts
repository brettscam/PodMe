...
export const PAST_EPISODES: Episode[] = [
  PAST_EPISODE_1,
  {
    ...
    segments: [
      ...
      { topic_id: 'entertainment', segment_type: 'topic', title: 'Oscar Season Heats Up', voice: 'insider', start_time_seconds: 880, duration_seconds: 140, script: 'Oscar nomination voting opens today, and the Best Picture race is shaping up to be a real contest. Denis Villeneuve\'s "Meridian" and Brady Corbet\'s "The Return" are the frontrunners, but don\'t sleep on the Sundance darling "Small Hours" which has been surging in guild voting.', sources: MOCK_SOURCES.entertainment, sort_order: 5 },
  ...
  },
  {
    ...
    segments: [
      ...
      { topic_id: 'entertainment', segment_type: 'topic', title: 'Weekend Streaming Picks', voice: 'insider', start_time_seconds: 1310, duration_seconds: 150, script: 'If you\'re settling in for some weekend viewing, "The Bear" Season Four arrives Friday on Hulu — early buzz says it\'s the best yet. Netflix dropped a surprise documentary about the making of Kendrick Lamar\'s latest album that\'s already trending number one. And if you want something lighter, the new season of "Poker Face" on Peacock is pure fun.', sources: MOCK_SOURCES.entertainment, sort_order: 6 },
  ...
  },
  {
    ...
    segments: [
      ...
      { topic_id: 'entertainment', segment_type: 'topic', title: 'Streaming Wars', voice: 'insider', start_time_seconds: 1105, duration_seconds: 140, script: 'Netflix reported that it now has three hundred twelve million subscribers globally after adding thirteen million last quarter. Disney Plus is countering by bundling Hulu content directly into the Disney Plus app starting next month. And HBO\'s "The Last of Us" Season Two premiere date was confirmed for April twentieth — expect the hype machine to start revving up this weekend.', sources: MOCK_SOURCES.entertainment, sort_order: 6 },
