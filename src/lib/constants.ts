...
export const SAMPLE_EPISODE: Episode = {
  ...
  segments: [
    { topic_id: null, segment_type: 'cold_open', title: 'Cold Open', voice: 'anchor', start_time_seconds: 0, duration_seconds: 50, script: 'Good morning, and welcome to your Sunday digest. I\'m glad you\'re here. What a week it was — NVIDIA rewrote the playbook on inference computing, Apple showed us the future with AR glasses, the EU AI Act went live yesterday, and ceasefire talks in Geneva produced actual framework language for the first time. Let\'s take the long view on all of it.', sources: [], sort_order: 0 },
    { topic_id: 'earnings', segment_type: 'topic', title: 'Week in Markets', voice: 'analyst', start_time_seconds: 50, duration_seconds: 300, script: 'The S&P five hundred finished the week at fifty-three twelve, up one point two percent, with the Nasdaq leading at one point eight percent. NVIDIA was the story of the week — data center revenue hit twenty point two billion, beating consensus by eight hundred million. But the real headline is that inference workloads officially crossed fifty percent of GPU compute. That\'s a structural shift. Adobe followed Thursday with solid numbers, and Oracle\'s Monday print showed cloud infrastructure jumping forty-six percent year-over-year. The rate cut narrative strengthened — Fed funds futures now price seventy-two percent odds of a June cut after Waller\'s speech. Looking ahead, Fed Chair Powell speaks Thursday, and we get housing starts and industrial production data.', sources: MOCK_SOURCES.earnings, sort_order: 1 },
    ...
    { topic_id: 'entertainment', segment_type: 'topic', title: 'The Bear Season 4 Review', voice: 'host', start_time_seconds: 1050, duration_seconds: 180, script: 'Alright, let\'s talk about The Bear. Season Four dropped Friday on Hulu and I binged all ten episodes. Without spoilers — it\'s the best season yet. The pacing is tighter, the kitchen scenes are more intense, and there\'s a mid-season episode that\'s going to have everyone talking on Monday. If you haven\'t started it yet, clear your afternoon. Also worth noting — Oscar nomination voting closed this week. The ceremony is March thirtieth and the frontrunners are "The Return" and Denis Villeneuve\'s "Meridian."', sources: MOCK_SOURCES.entertainment, sort_order: 5 },
...
const PAST_EPISODE_1: Episode = {
  ...
  segments: [
    { topic_id: null, segment_type: 'cold_open', title: 'Cold Open', voice: 'host', start_time_seconds: 0, duration_seconds: 45, script: 'Well good mornin\', y\'all. It\'s Saturday, March fourteenth, twenty twenty-six, and this is PuckPuck. We\'ve got a great weekend edition for you. Big earnings week just wrapped — NVIDIA crushed it, Apple dropped some jaw-dropping hardware, and ceasefire talks in Geneva are looking more promising than they have in months. Plus we\'ve got some Marin local gems for your weekend. Grab that coffee and let\'s get into it.', sources: [], sort_order: 0 },
    { topic_id: 'earnings', segment_type: 'topic', title: 'Markets & Earnings', voice: 'analyst', start_time_seconds: 45, duration_seconds: 300, script: 'Let\'s talk markets. The S&P closed the week at fifty-three twelve, up six tenths of a percent on the week, largely on the back of NVIDIA\'s blowout earnings. NVIDIA reported data center revenue of twenty point two billion, another record. But the real signal isn\'t the top line — it\'s the inference-to-training revenue ratio. Jensen Huang confirmed inference workloads have crossed fifty percent of data center compute. That fundamentally changes the NVIDIA thesis from a training play to an inference platform. Adobe reported Thursday with solid numbers. And Oracle\'s earnings earlier in the week showed cloud infrastructure revenue jumping forty-six percent year-over-year. Fed funds futures are now pricing in a seventy-two percent probability of a June rate cut.', sources: MOCK_SOURCES.earnings, sort_order: 1 },
    { topic_id: 'tech', segment_type: 'topic', title: 'Technology', voice: 'correspondent', start_time_seconds: 345, duration_seconds: 240, script: 'In tech news, Apple held an unannounced spring event this week. The headline is the new iPad Pro with the M4 Ultra chip. But the real surprise was Apple Glass — lightweight AR glasses that pair with your iPhone. Ship date is June. In AI news, Anthropic released Claude four point five Opus last week, scoring ninety-two percent on the SWE-bench full benchmark. And the EU\'s AI Act enforcement officially begins next week.', sources: MOCK_SOURCES.tech, sort_order: 2 },
    { topic_id: 'world', segment_type: 'topic', title: 'World News', voice: 'anchor', start_time_seconds: 585, duration_seconds: 270, script: 'Turning to world news now. Ceasefire talks between Ukraine and Russia resumed in Geneva this week, and there\'s cautious optimism for the first time in months. A new framework proposed by Turkish and Brazilian mediators separates the territorial question from the security guarantee question — a clever bit of diplomacy. In Asia, China announced a five hundred billion dollar economic stimulus package focused on domestic consumption. And India\'s space agency ISRO successfully tested its reusable launch vehicle.', sources: MOCK_SOURCES.world, sort_order: 3 },
    ...
    { topic_id: 'local', segment_type: 'topic', title: 'Marin Local', voice: 'neighbor', start_time_seconds: 1035, duration_seconds: 270, script: 'Alright, let\'s talk about what\'s happening right here in Marin this weekend. The Board of Supervisors passed the updated Housing Element last night — big news for the county. Good news for the weekend crowd — the San Rafael farmer\'s market is going year-round starting today. Saturdays and Sundays, eight AM to one PM. And for the hikers — there\'s a new trail opening on Mount Tamalpais today. The Azalea Hill Loop, a two point three mile moderate trail. Dedication ceremony at ten AM at Rock Spring trailhead. Perfect weather for it.', sources: MOCK_SOURCES.local, sort_order: 5 },
    { topic_id: 'creative', segment_type: 'topic', title: 'Photography & Creative', voice: 'host', start_time_seconds: 1305, duration_seconds: 90, script: 'Quick creative segment. The photography world is buzzing about a potential Fujifilm and Hasselblad tie-up. According to DPReview sources, Fujifilm has been in advanced talks to acquire Hasselblad\'s medium format division. Also, the new Sigma fifty millimeter f-one-point-two Art lens is getting rave early reviews — optically stunning, but at one point four kilograms, you might want to hit the gym before your next portrait session.', sources: MOCK_SOURCES.creative, sort_order: 6 },
    { topic_id: 'entertainment', segment_type: 'topic', title: 'Entertainment', voice: 'host', start_time_seconds: 1395, duration_seconds: 120, script: 'In entertainment, Oscar nomination voting closed this week, with the ceremony set for March thirtieth. The frontrunners for Best Picture are "The Return" and "Meridian" from Denis Villeneuve. And the big streaming news — The Bear Season Four dropped yesterday on Hulu. Early reviews are calling it the best season yet. If you haven\'t started your weekend binge yet, now\'s the time.', sources: MOCK_SOURCES.entertainment, sort_order: 7 },
    { topic_id: null, segment_type: 'wrap_up', title: 'Wrap & Look-Ahead', voice: 'host', start_time_seconds: 1515, duration_seconds: 60, script: 'That\'s your Saturday briefing, folks. This weekend — hit the new Azalea Hill Loop on Mount Tam, check out the year-round farmer\'s market, and settle in for The Bear Season Four. Next week — EU AI Act enforcement kicks in, Fed Chair Powell speaks Thursday, and we\'ll have full coverage of any Apple Glass developments. Y\'all have a wonderful weekend. This has been PuckPuck.', sources: [], sort_order: 8 },
  ],
}
...
export const DEFAULT_USER_TOPICS = [
  { id: '1', user_id: 'local-user', topic_id: 'earnings', weight: 'featured' as const, pinned: true, voice_override: 'analyst', sort_order: 0, custom_tags: ['NVIDIA earnings', 'Fed meeting', 'Micron', 'Energy', 'S&P 500', 'Housing', 'Software', 'Tech'] },
...
export const PAST_EPISODES: Episode[] = [
  PAST_EPISODE_1,
  {
    ...
    segments: [
      ...
      { topic_id: 'entertainment', segment_type: 'topic', title: 'Oscar Season Heats Up', voice: 'host', start_time_seconds: 880, duration_seconds: 140, script: 'Oscar nomination voting opens today, and the Best Picture race is shaping up to be a real contest. Denis Villeneuve\'s "Meridian" and Brady Corbet\'s "The Return" are the frontrunners, but don\'t sleep on the Sundance darling "Small Hours" which has been surging in guild voting.', sources: MOCK_SOURCES.entertainment, sort_order: 5 },
      { topic_id: null, segment_type: 'wrap_up', title: 'Wrap & Look-Ahead', voice: 'host', start_time_seconds: 1020, duration_seconds: 50, script: 'That\'s your Monday, folks. Keep an eye on Apple\'s event tomorrow — we\'ll have full coverage Wednesday morning. NVIDIA earnings drop Wednesday after the bell. And the Marin County housing vote is Tuesday evening at six. Y\'all have a great start to the week.', sources: [], sort_order: 6 },
    ],
  },
  {
    ...
    segments: [
      { topic_id: null, segment_type: 'cold_open', title: 'Cold Open', voice: 'anchor', start_time_seconds: 0, duration_seconds: 50, script: 'Good morning, and welcome to your weekend digest. I\'m glad you\'re taking a moment to catch up. It was a big week — markets rallied on Oracle\'s cloud surge, the AI arms race added a new chapter with Anthropic and Google trading blows, and China unveiled the largest stimulus package in a decade. Let\'s walk through what matters and what to watch next week.', sources: [], sort_order: 0 },
  ...
  },
  {
    ...
    segments: [
      ...
      { topic_id: 'entertainment', segment_type: 'topic', title: 'Streaming Wars', voice: 'host', start_time_seconds: 1105, duration_seconds: 140, script: 'Netflix reported that it now has three hundred twelve million subscribers globally after adding thirteen million last quarter. Disney Plus is countering by bundling Hulu content directly into the Disney Plus app starting next month. And HBO\'s "The Last of Us" Season Two premiere date was confirmed for April twentieth — expect the hype machine to start revving up this weekend.', sources: MOCK_SOURCES.entertainment, sort_order: 6 },
      { topic_id: null, segment_type: 'wrap_up', title: 'Wrap & Weekend Preview', voice: 'host', start_time_seconds: 1245, duration_seconds: 55, script: 'That wraps your Friday briefing. This weekend — Selection Sunday for March Madness, the San Rafael farmers market goes year-round starting Sunday, and the wildflower bloom on Mount Tam is peaking. Next week is huge — Apple\'s expected event, NVIDIA and Adobe earnings, and the Marin housing vote Tuesday night. Enjoy the weekend, and we\'ll see you Saturday morning.', sources: [], sort_order: 7 },
    ],
  },
  {
