...
const FEED_REGISTRY: Record<string, RssFeed[]> = {
  earnings: [
    ...
    { url: 'https://www.bloomberg.com/feed/podcast/top-news', name: 'Bloomberg', tier: 1 },
  ],
  tech: [
    ...
    { url: 'https://9to5mac.com/feed/', name: '9to5Mac', tier: 3 },
  ],
  world: [
    ...
    { url: 'https://www.reuters.com/rssFeed/worldNews', name: 'Reuters World', tier: 1 },
  ],
  local: [
  ...
  creative: [
    ...
    { url: 'https://www.itsnicethat.com/rss', name: "It's Nice That", tier: 2 },
  ],
  sports: [
    ...
    { url: 'https://theathletic.com/rss/', name: 'The Athletic', tier: 1 },
  ],
  travel: [
    ...
    { url: 'https://www.cntraveler.com/feed/rss', name: 'Conde Nast Traveler', tier: 2 },
  ],
  entertainment: [
    ...
    { url: 'https://www.rollingstone.com/feed/', name: 'Rolling Stone', tier: 2 },
  ],
}
